...
<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_jcli_jndi_file-service')"/></xsl:variable>
...
java.naming.provider.url=${jndi.file.url}
</xsl:variable>
