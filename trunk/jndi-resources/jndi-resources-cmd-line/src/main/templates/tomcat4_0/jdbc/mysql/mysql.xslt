...
<!-- <xsl:variable name="jdbc.factory">com.mysql.jdbc.jdbc2.optional.MysqlDataSourceFactory</xsl:variable>-->
...
<xsl:variable  name="basefilename">catalina.base/conf/<xsl:value-of select="$currentid"/>_mysql-ds</xsl:variable>
