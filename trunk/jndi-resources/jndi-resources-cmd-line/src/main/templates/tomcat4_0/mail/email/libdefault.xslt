...
<xsl:template match="jndi:resources[@id=$currentid]/jndi:resource[@familly=$familly]">
		...
		<Resource auth="Container" type="javax.mail.Address">
		...
		<ResourceParams>
			...
			<parameter>
				<name>factory</name>
				<value>org.jndiresources.factory.InternetAddressFactory</value>
			</parameter>

			<parameter>
				<name>type</name>
				<value>javax.mail.Address</value>
			</parameter>
			...
			<parameter>
				<name>value</name>
				<value><xsl:value-of select="jndi:property[@name='email']/@value"/></value>
			</parameter>
		</ResourceParams>
