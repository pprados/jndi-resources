...
<xsl:variable name="jassmodule"><xsl:value-of select="substring-after($familly,'jaas/')"/></xsl:variable>

<xsl:template match="jndi:resources[@id=$currentid]">
	<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_',$jassmodule,'_jaas-service')"/></xsl:variable>
...
<mbean code="org.jboss.naming.NamingAlias"
    ...
    <attribute name="ToName">java:jaas/jmx-console</attribute>
