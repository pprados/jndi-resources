...
<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'-default-ds')"/></xsl:variable>
...
<mbean code="org.jboss.naming.NamingAlias"
       name="{$currentid}:database=DefaultDS,jndiName={@name}">
