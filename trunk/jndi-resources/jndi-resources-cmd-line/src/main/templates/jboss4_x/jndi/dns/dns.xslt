...
<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_jndi_dns-service')"/></xsl:variable>
...
java.naming.authoritative=${jndi.dns.authoritative}
java.naming.provider.url=${jndi.dns.url}
com.sun.jndi.dns.lookup.attr=${jndi.dns.lookup.attr}
com.sun.jndi.dns.recursion=${jndi.dns.recursion}
</xsl:variable>
