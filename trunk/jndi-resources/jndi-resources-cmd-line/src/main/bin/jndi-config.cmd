...
java %JAVA_OPTS% -classpath "%CLASSPATH%" -Djndi.resources.home="%JNDI_RESOURCES_HOME%" com.googlecode.jndiresources.config.JNDIConfig -t "%JNDI_RESOURCES_HOME%/templates" %*