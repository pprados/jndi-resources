...
<xsl:template name="footer">
	...
	<xsl:value-of select="tools:info(concat('Generate ','jboss.server.conf/conf/jboss-xid-service.jndi'))"/>
	<xsl:value-of select="tools:fileCopy('../../../jboss4_x/jdbc/oracle/update-xid-factory.xslt',concat($targetdir,'../xslt/'))"/>
	<xsl:result-document  href="{concat($targetdir,'jboss.server.conf/conf/jboss-service.jndi')}">
	<xsl:text>&#xA;</xsl:text>
	<xsl:comment>Generated by jndi-resources v<xsl:value-of select="$version"/></xsl:comment>
	<xsl:text>&#xA;</xsl:text>
	<xsl:processing-instruction name="jndi-stylesheet">href="xslt/update-xid-factory.xslt"</xsl:processing-instruction>
	<xsl:text>&#xA;</xsl:text>
	<xsl:processing-instruction name="jndi-stylesheet">href="xslt/save.xslt" target="conf/jboss-service.xml"</xsl:processing-instruction>
	<xsl:text>&#xA;</xsl:text>
	<server>
