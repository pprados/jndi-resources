...
<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_jcli_jndi_rmi-service')"/></xsl:variable>
...
java.naming.provider.url=${jndi.rmi.url}
</xsl:variable>
