...
<xsl:template match="jndi:resources[@id=$currentid]/jndi:resource[@familly=$familly]">
        <xsl:if test="not(jndi:property[@name='link'])">
          	<xsl:value-of
          		select="error(sch:QName('error9999'),concat('The property link must be set for resource ',@familly))" />
        </xsl:if>
		...
		<mbean code="org.jboss.naming.NamingAlias"
		    ...
		    <attribute name="ToName"><xsl:value-of select="jndi:property[@name='link']/@value"/></attribute>
