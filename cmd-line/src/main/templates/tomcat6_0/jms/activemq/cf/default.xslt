...
<xsl:variable  name="basefilename">
	<xsl:value-of select="concat('catalina.base/conf/',$currentid,'_activemq_cf_service')"/>
</xsl:variable>
...
Use the query "broker.<property>" to configure the broker.
http://www.docjar.com/html/api/org/activemq/config/BrokerXmlConfigFromJNDITest.java.html
...
properties.put("useEmbeddedBroker", Boolean.TRUE);
		...
		clientIDPrefix=""
		statsEnabled="false"
		producedWindowSize="0"
		warnAboutUnstarted="500"
 -->
