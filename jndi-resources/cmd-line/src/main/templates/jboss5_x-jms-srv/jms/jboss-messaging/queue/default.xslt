...
<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_srv_jboss-messaging_queue-service')"/></xsl:variable>
...
<xsl:template match="jndi:resources[@id=$currentid]/jndi:resource[@familly=$familly]">
	...
	<mbean code="org.jboss.jms.server.destination.QueueService"
		...
		<xsl:call-template name="attribute">
			...
			<xsl:with-param name="alias">FullSize</xsl:with-param>
