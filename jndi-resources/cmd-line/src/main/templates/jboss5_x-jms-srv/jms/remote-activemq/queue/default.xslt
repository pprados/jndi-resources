...
<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_srv_remote-activemq_queue-service')"/></xsl:variable>
...
<xsl:template match="jndi:resources[@id=$currentid]/jndi:resource[@familly=$familly]">
		...
		<mbean code="org.jboss.naming.NamingAlias"
		    ...
		    <attribute name="ToName">
               	${jndi-prefix}_remoteActiveMQ/dynamicQueues/<xsl:call-template name="basename">
