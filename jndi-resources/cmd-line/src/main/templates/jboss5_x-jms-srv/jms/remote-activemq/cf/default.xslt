...
<xsl:include href="../../../../jboss5_x/install-drivers.xslt"/>
<xsl:variable name="lib"><xsl:value-of select="concat($targetdir,'jboss.server.conf/lib/')"/></xsl:variable>

<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_srv_remote-activemq_cf-service')"/></xsl:variable>
...
<xsl:template match="jndi:resources[@id=$currentid]/jndi:resource[@familly=$familly]">
	...
	<mbean code="org.jboss.naming.NamingAlias"
	    ...
	    <attribute name="FromName"><xsl:value-of select="@name"/></attribute>
	    <attribute name="ToName">${jndi-prefix}_remoteActiveMQ/ConnectionFactory</attribute>
		<depends>jboss:service=Naming</depends>
	</mbean>
</xsl:template>
