...
<xsl:variable  name="basefilename"><xsl:value-of select="concat('deploy/',$currentid,'/',$currentid,'_srv_activemq_topic-service')"/></xsl:variable>
...
<xsl:template match="jndi:resources[@id=$currentid]/jndi:resource[@familly=$familly]">
	...
	>
		...
		<attribute name="Properties">
		  PhysicalName=topic.<xsl:call-template name="basename">
